...
ProjectList.prototype.listDescriptors = function () {
    return _.pluck(this.collection.active, 'descriptor');
};
...
ProjectList.prototype.startAllAuto = function () {
    ...
    return new Promise(function (resolve, reject) {
        async.eachSeries(_.values(this.loaded), function (project, callback) {
...
ProjectList.prototype.shutdown = function (callback) {
    console.log('projects: stopping all active');
    async.eachSeries(this.collection.active, function (project, callback) {
        if (project.running) {
